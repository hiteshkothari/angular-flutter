...
class CustomAppDemo extends StatefulWidget {
  const CustomAppDemo({super.key, required this.text});

  final ValueNotifier<String> text;

  @override
  State<CustomAppDemo> createState() => _CustomAppDemoState();
}

class _CustomAppDemoState extends State<CustomAppDemo> {
